...
public class CardListMasterTester {
    ...
    public void stage1()
    {
     ...
     masterList1.add(new PremiumCard(200,200));
    ...
    public void stage2()
    {
     ...
     // Can we add in other Locations? 
      ...
      SO.print("Add front      : "); 
      SO.println(masterList1);   
      masterList1.add(4, new Card(9,9));
      masterList1.add(4, new Card(7,7));
    ...
    {     
     ...
     // can we add more cards
      ...
      masterList1.add(2, new Card(11));
      masterList1.add(4, new Card(22));
      masterList1.add(6, new Card(33));
      masterList1.add(8, new Card(44));
      SO.print("After More     : "); 
      SO.println(masterList1);
    }
    public void stage4()
    ...
    // STAGE 9
     ...
     public void stage9()
     {
      ...
      SO.println(masterList1.indexOf(new Card(220,220)));
